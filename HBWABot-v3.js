...
const prem = JSON.parse(fs.readFileSync('https://raw.githubusercontent.com/HBMods-OFC/Base/main/HBWABot-v3/Premium.json'))
const hbmods = JSON.parse(fs.readFileSync('https://raw.githubusercontent.com/HBMods-OFC/Base/main/HBWABot-v3/Developer.json'))
const Englo = JSON.parse(fs.readFileSync('https://raw.githubusercontent.com/HBMods-OFC/Base/main/HBWABot-v3/Ka-hming.json'))
